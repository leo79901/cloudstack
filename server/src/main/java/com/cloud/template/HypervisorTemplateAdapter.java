...
public class HypervisorTemplateAdapter extends TemplateAdapterBase {
     ...
     * @param url url
     */
    private Long performDirectDownloadUrlValidation(final String format, final Hypervisor.HypervisorType hypervisor, final String url, final List<Long> zoneIds) {
        HostVO host = null;
    ...
    public TemplateProfile prepare(RegisterIsoCmd cmd) throws ResourceAllocationException {
        ...
        if (cmd.isDirectDownload()) {
            ...
            Long templateSize = performDirectDownloadUrlValidation(ImageFormat.ISO.getFileExtension(), Hypervisor.HypervisorType.KVM, url, zoneIds);
