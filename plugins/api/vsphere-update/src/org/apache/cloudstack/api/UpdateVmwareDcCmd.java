...
import org.apache.cloudstack.vmware.VmwareDatacenterUpdateService;
...
@APICommand(name = UpdateVmwareDcCmd.APINAME, description = "Updates a VMware datacenter details for a zone",
        responseObject = VmwareDatacenterResponse.class, requestHasSensitiveInfo = true, responseHasSensitiveInfo = true,
...
public class UpdateVmwareDcCmd extends BaseCmd {
    ...
    @Inject
    public VmwareDatacenterUpdateService vmwareDatacenterService;
