...
public class VmwareUpdateServiceImplTest {

    @Spy
    @InjectMocks
    private VmwareUpdateServiceImpl vmwareUpdateService;
    ...
    public void updateVmwareDatacenterNoUpdate() {
        VmwareDatacenter vmwareDatacenter = vmwareUpdateService.updateVmwareDatacenter(updateVmwareDcCmd);
    ...
    public void updateVmwareDatacenterNormalUpdate() {
        ...
        final VmwareDatacenter vmwareDatacenter = vmwareUpdateService.updateVmwareDatacenter(updateVmwareDcCmd);
